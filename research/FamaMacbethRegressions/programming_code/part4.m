...
part4_a.Properties.VariableNames  = {'Date', 'Part A- Intercept', 'Part A- R2', 'Part A- Intercept t-stat', 'Part A- R2 t-stat', 'Part B- Intercept', 'Part B- Liq Beta', 'Part B- Intercept t-stat', 'Part B- Liq Beta t-stat','Part C- Intercept','Part C- R2', 'Part C- Liq Beta', 'Part C- Intercept t-stat','Part C- R2 t-stat', 'Part C- Liq Beta t-stat'  };
writetable(part4_a, fullfile(results_directory, 'part_4_all.csv'),'WriteRowNames',true);

pooled = mean(fmb);
pooled = pooled(:,2:length(fmb(1,:)));
part4_a = array2table(pooled);
part4_a.Properties.VariableNames  = {'Part A- Intercept', 'Part A- R2', 'Part A- Intercept t-stat', 'Part A- R2 t-stat', 'Part B- Intercept', 'Part B- Liq Beta', 'Part B- Intercept t-stat', 'Part B- Liq Beta t-stat','Part C- Intercept','Part C- R2', 'Part C- Liq Beta', 'Part C- Intercept t-stat','Part C- R2 t-stat', 'Part C- Liq Beta t-stat'  };
writetable(part4_a, fullfile(results_directory, 'part_4_pooled.csv'),'WriteRowNames',true);
